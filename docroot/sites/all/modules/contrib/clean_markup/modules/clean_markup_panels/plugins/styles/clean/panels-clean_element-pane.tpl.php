...
<?php endif; ?>
<?php if ($pane_wrapper): ?><<?php print $pane_wrapper_tag; ?><?php print $clean_markup_attributes; ?> class="<?php print $classes . $clean_markup_classes; ?>" <?php print $id; ?>><?php endif; ?>
	<?php if ($inner_wrapper): ?><div class="inner pane-inner"><?php endif; ?>
	  ...
	  <?php if ($content_wrapper): ?><<?php print $content_wrapper_tag; ?> class="pane-content"><?php endif; ?>
