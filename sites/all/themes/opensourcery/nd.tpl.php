...
<div class="buildmode-<?php print $node->build_mode; ?>">
  <div class="node node-type-<?php print $node->type; ?> <?php if (isset($node_classes)): print $node_classes; endif; ?><?php if ($sticky && $node->build_mode == 'sticky'): print ' sticky'; endif; ?><?php if (!$status): print ' node-unpublished'; endif; ?>">
    <?php print $content; ?>
  </div> <!-- /node -->
</div> <!-- /buildmode -->
