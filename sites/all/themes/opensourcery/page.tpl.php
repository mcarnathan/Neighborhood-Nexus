...
<head>
  ...
  <?php print "
  <!--[if IE 6]>
  <script src=\"/" . path_to_theme() . "/DD_belatedPNG_0.0.7a-min.js\"></script>
  <script>
      DD_belatedPNG.fix('#header')
      DD_belatedPNG.fix('#logo-title')
      DD_belatedPNG.fix('#logo a')
      DD_belatedPNG.fix('#site-name a')
  </script>
  <![endif]-->
  "; ?>
</head>
      ...
      <div id="content"><div id="content-inner">
        ...
        <?php if ($breadcrumb || $title || $tabs || $help || $messages): ?>
          <div id="content-header">
            ...
            <?php if ($title && strpos($body_classes, 'neighborhood-corner') === FALSE): ?>
        ...
        <div id="content-area">
            <?php if ( $content || $content_left ): ?>
              <div id="content-left" class="region region-content_left
                <?php
                    if ($content_right) {
                        print "content_left_with_right";
                    }
                    else {
                        print "content_left_without_right";
                    }
                ?>
              ">
                <?php if ($title && strpos($body_classes, 'neighborhood-corner') !== FALSE): ?>
            ...
            <?php if ( $content_right ): ?>
              <div id="content-right" class="region region-content_right
                <?php
                    if ($content_left || $content) {
                        print "content_right_with_left";
                    }
                    else {
                        print "content_right_without_left";
                    }
                ?>
              ">
